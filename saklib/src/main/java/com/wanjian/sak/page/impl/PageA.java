...
public class PageA extends BasePager implements View.OnClickListener {
    private static final String TAG = PageA.class.getSimpleName();

    @Override
    public void onCreate(Bundle params) {
        super.onCreate(params);
        setContentView(R.layout.pager_test_pagea);
